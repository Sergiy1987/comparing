        ...
        stages {
            ...
            stage('Chrome') {
                ...
                steps {
                        ...
                        sh 'export PERCY_TOKEN=${PERCY_TOKEN} & npx percy exec -- mvn clean test -ea -DbrowserName="Chrome" -DplatformName="Windows_10" -DscreenResolution="1280x1024" -Dsurefire.suiteXmlFiles=testng.xml'//-P chrome
