        ...
        stages {
            ...
            stage('Chrome') {
                ...
                steps {
                        ...
                        sh 'export PERCY_TOKEN=${PERCY_TOKEN} & npx percy exec -- mvn clean test -DbrowserName="Chrome" -DplatformName="Windows_10" -DscreenResolution="1280x1024" -P Windows_10_Chrome'//-P chrome
